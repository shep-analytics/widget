...
module.exports = {
  ...
  networks: {
    ...
    mumbai: {
    provider: () => new HDWalletProvider(mnemonic, `https://rpc-mumbai.maticvigil.com/v1/6050cbb67ea55b5741a94d1739c74c9a38665bde`),
    network_id: 80001,
    confirmations: 2,
    timeoutBlocks: 200,
    skipDryRun: true
  ...
  api_keys: {
    ...
    polygonscan: '1T5JRVB3GN88STV8IDD2N4WYRGBJ8GFI6V'
  },
